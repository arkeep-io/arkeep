...
// SnapshotFileEntry represents a single file or directory within a Restic snapshot,
// as returned by `restic ls --json`.
...
// SnapshotBrowseReport is sent by the agent in response to a
// JOB_TYPE_LIST_SNAPSHOT_FILES assignment.
...
const file_agent_proto_rawDesc = "" +
	...
	"\x11SnapshotFileEntry\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04size\x18\x03 \x01(\x03R\x04size\x12\x14\n" +
	"\x05mtime\x18\x04 \x01(\tR\x05mtime\"\xa2\x01\n" +
	"\x14SnapshotBrowseReport\x12\x19\n" +
	"\bagent_id\x18\x01 \x01(\tR\aagentId\x12%\n" +
	...
	"\x1cJOB_TYPE_LIST_SNAPSHOT_FILES\x10\x06*\x8a\x01\n" +
	"\tJobStatus\x12\x1a\n" +
	...
	"\x0fLOG_LEVEL_ERROR\x10\x042\xc4\x04\n" +
	"\fAgentService\x12;\n" +
	...
	"\x14ReportSnapshotBrowse\x12\x1b.agent.SnapshotBrowseReport\x1a\x1d.agent.SnapshotBrowseResponseB*Z(github.com/arkeep-io/arkeep/shared/protob\x06proto3"
...
var file_agent_proto_depIdxs = []int32{
	...
	23, // 3: agent.JobAssignment.scheduled_at:type_name -> google.protobuf.Timestamp
	1,  // 4: agent.JobStatusReport.status:type_name -> agent.JobStatus
	23, // 5: agent.JobStatusReport.timestamp:type_name -> google.protobuf.Timestamp
	23, // 6: agent.DestinationStatusReport.started_at:type_name -> google.protobuf.Timestamp
	2,  // 7: agent.LogEntry.level:type_name -> agent.LogLevel
	23, // 8: agent.LogEntry.timestamp:type_name -> google.protobuf.Timestamp
	...
	3,  // 11: agent.AgentService.Register:input_type -> agent.RegisterRequest
	6,  // 12: agent.AgentService.Heartbeat:input_type -> agent.HeartbeatRequest
	9,  // 13: agent.AgentService.StreamJobs:input_type -> agent.StreamJobsRequest
	11, // 14: agent.AgentService.ReportJobStatus:input_type -> agent.JobStatusReport
	13, // 15: agent.AgentService.ReportDestinationStatus:input_type -> agent.DestinationStatusReport
	15, // 16: agent.AgentService.StreamLogs:input_type -> agent.LogEntry
	18, // 17: agent.AgentService.ReportVolumeList:input_type -> agent.VolumeListReport
	21, // 18: agent.AgentService.ReportSnapshotBrowse:input_type -> agent.SnapshotBrowseReport
	5,  // 19: agent.AgentService.Register:output_type -> agent.RegisterResponse
	8,  // 20: agent.AgentService.Heartbeat:output_type -> agent.HeartbeatResponse
	10, // 21: agent.AgentService.StreamJobs:output_type -> agent.JobAssignment
	12, // 22: agent.AgentService.ReportJobStatus:output_type -> agent.JobStatusResponse
	14, // 23: agent.AgentService.ReportDestinationStatus:output_type -> agent.DestinationStatusResponse
	16, // 24: agent.AgentService.StreamLogs:output_type -> agent.LogStreamResponse
	19, // 25: agent.AgentService.ReportVolumeList:output_type -> agent.VolumeListResponse
	22, // 26: agent.AgentService.ReportSnapshotBrowse:output_type -> agent.SnapshotBrowseResponse
