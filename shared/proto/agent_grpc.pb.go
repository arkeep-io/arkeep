...
func (c *agentServiceClient) ReportSnapshotBrowse(ctx context.Context, in *SnapshotBrowseReport, opts ...grpc.CallOption) (*SnapshotBrowseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SnapshotBrowseResponse)
	err := c.cc.Invoke(ctx, AgentService_ReportSnapshotBrowse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) ReportSnapshotImport(ctx context.Context, in *SnapshotImportReport, opts ...grpc.CallOption) (*SnapshotImportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SnapshotImportResponse)
	err := c.cc.Invoke(ctx, AgentService_ReportSnapshotImport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAgentServiceServer) ReportSnapshotBrowse(context.Context, *SnapshotBrowseReport) (*SnapshotBrowseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportSnapshotBrowse not implemented")
}
...
func _AgentService_ReportSnapshotBrowse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SnapshotBrowseReport)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).ReportSnapshotBrowse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_ReportSnapshotBrowse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).ReportSnapshotBrowse(ctx, req.(*SnapshotBrowseReport))
	}
	return interceptor(ctx, in, info, handler)
}

func _AgentService_ReportSnapshotImport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SnapshotImportReport)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).ReportSnapshotImport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_ReportSnapshotImport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).ReportSnapshotImport(ctx, req.(*SnapshotImportReport))
	}
	return interceptor(ctx, in, info, handler)
}
